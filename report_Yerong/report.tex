	...
	\section{Mechanisms \label{sec:mech}}
		...
		\subsection{(N+1)-tuple Network}
			...
			\begin{figure}[t]
				...
				\end{center}
   \caption{3-pair loss with $\lambda L_2$ constraint and weight $\lambda=0.3$.  We also added negative cutoff $m$ in equation \ref{eq:negative}, this proves improve the trainig result a little bit.}
